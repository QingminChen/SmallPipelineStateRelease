...
def notify_topic_subscriber(event, context):
    ...
    if pubsub_message=='ok':
         ...
         update_release_environment_response = release_client.update_release_environment(azure.devops.v5_1.release.models.ReleaseEnvironmentUpdateMetadata(comment="Test trigger API",status='inProgress'),'PipelineIntegrateWithGCPDeployment', 58, 99)